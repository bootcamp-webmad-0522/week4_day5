// IMPORTANTE: SEED NO VÁLIDO DE REFRENCIA
...
const MONGO_URI = 'mongodb://localhost/books-app-0522-populated'    // IMPORTANTE: El nombre de la BBDD debe coincidir aquí y en el .env
mongoose
    .connect(MONGO_URI)
